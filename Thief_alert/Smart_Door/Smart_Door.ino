...
#define relayPin D5                   //declare the relay pin
#define WLAN_SSID "Shawon"          //enter your WiFi network name within the double quotes & 
#define WLAN_PASS "Afnan1100"          //password here
#define AIO_SERVER       "io.adafruit.com"
#define AIO_SERVERPORT   1883               // use 8883 is used for SSL
#define AIO_USERNAME     "shafinBot"       //Username of Adafruit IO (for this click the Golden Key in Adafruit IO Dashboard)
#define AIO_KEY          "aio_QvVe29fNpX593KQynjBSW86vhjtp"       //key of Adafruit IO (for this click the Golden Key in Adafruit IO Dashboard)
